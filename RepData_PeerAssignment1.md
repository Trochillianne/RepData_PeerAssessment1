...
-   [Loading and pre-processing the
    data](#loading-and-pre-processing-the-data)
-   [**1. What is mean total number of steps taken per
    day?**](#what-is-mean-total-number-of-steps-taken-per-day)
-   [**2. Which is the average daily activity
    pattern?**](#which-is-the-average-daily-activity-pattern)
-   [**3. Imputing missing values**](#imputing-missing-values)
-   [**4. Are there differences in activity patterns between weekdays
    and
